...
This repository provides [computer vision](#models) [services](#usage) that can be used with [PhotoPrism](https://github.com/photoprism/photoprism) and other applications. Their API [accepts an image URL](#example-request) and returns, for example, a [suitable caption](#example-response) in response.
